...
export class TipoEquipamentoService {
    ...
    update(id: number, tipoEquipamento: CreateTipoEquipamentoDto): Observable<TipoEquipamento> {
        return this.http.put<TipoEquipamento>(this.url + "/api/nisac/tipo/equipamento/update/" + id, tipoEquipamento);
    }

    changeStatus(id: number, status: boolean): Observable<TipoEquipamento> {
        return this.http.put<TipoEquipamento>(this.url + "/api/nisac/tipo/equipamento/" + id + "/" + status, {});
    }
}
