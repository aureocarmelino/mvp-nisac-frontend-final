        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button type="button" class="layout-topbar-action" routerLink="utilizador/perfil" >
...
export class AppTopbar
{
    ...
    constructor(private toastr: ToastrService, public layoutService: LayoutService,
    ...
    logout()
    {
        ...
        {
          this.spinner.hide();
          this.toastr.success('Sessão terminada', 'Sucesso', {
            progressBar: true,
          });
          ...
          console.error('Erro ao terminar a sessão:', erro);
          this.spinner.hide();
          this.toastr.error(erro, 'Erro ao terminar a sessão', {
            progressBar: true,
          });
        });
    }
